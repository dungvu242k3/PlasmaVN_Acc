...
const MachineIssueRequestForm = () => {
    ...
    return (
        <div id="print-area" className="max-w-4xl mx-auto bg-white p-8 md:p-12 shadow-lg mb-10 text-black print:shadow-none print:p-0">
            {/* Header section */}
            ...
            <div className="space-y-4 text-[15px] leading-relaxed">
                    ...
                    <div className="flex items-center w-full md:w-auto print:w-auto md:ml-4 print:ml-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`focus:outline-none px-2 py-1 w-40 bg-transparent print:border-none print:p-0 print:-ml-2 ${isSearching ? 'bg-blue-50' : ''}`}
                            />
                            {isSearching && <span className="absolute -right-6 top-1.5 w-4 h-4 rounded-full border-2 border-primary border-t-transparent animate-spin no-print"></span>}
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row print:flex-row md:items-center print:items-center mt-6">
                    ...
                    <div className="flex flex-wrap gap-6 flex-1 items-center">
                        {Object.keys(formData.machineType).map(type => (
                            <label key={type} onClick={() => handleCheckboxChange('machineType', type)} className="flex items-center gap-6 cursor-pointer">
                ...
                <div className="mt-6 mb-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 print:grid-cols-3 gap-y-1 gap-x-4 pl-8 md:pl-24 print:pl-24">
                        {Object.keys(formData.machineColor).map(color => (
                            <label key={color} onClick={() => handleCheckboxChange('machineColor', color)} className="flex items-center gap-6 cursor-pointer">
                ...
                <div className="flex flex-col md:flex-row print:flex-row md:items-center print:items-center mt-4">
                    ...
                    <div className="flex gap-10">
                        {Object.keys(formData.shippingMethod).map(method => (
                            <label key={method} onClick={() => handleCheckboxChange('shippingMethod', method)} className="flex items-center gap-6 cursor-pointer">
                ...
                <div className="flex flex-col md:flex-row print:flex-row md:items-center print:items-center mt-4">
                    ...
                    <div className="flex flex-wrap gap-10">
                        {Object.keys(formData.issueType).map(type => (
                            <label key={type} onClick={() => handleCheckboxChange('issueType', type)} className="flex items-center gap-6 cursor-pointer">
                ...
                <div className="mt-6 flex flex-col">
                    ...
                    <textarea
                        ...
                        className="w-full border-b border-dotted border-gray-400 focus:outline-none min-h-[60px] resize-none bg-transparent print:border-none print:min-h-0"
                        placeholder=""
                    />
                </div>
            </div>
            ...
            {/* Print Action / Floating button (Hidden in print) */}
            <div className="fixed bottom-6 right-6 no-print flex gap-3 z-50">
                <button
                    onClick={handlePrint}
                    className="flex items-center gap-2 bg-emerald-600 text-white px-6 py-3 rounded-full shadow-lg shadow-emerald-600/30 hover:bg-emerald-700 transition-all font-bold text-sm transform hover:scale-105 active:scale-95"
                >
                    <Printer size={18} />
                    IN PHIẾU XUẤT MÁY
                </button>
